              ...
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                  ...
                  <div
                    ...
                    data-aos-delay="300"
                  >
                   <a href="http://127.0.0.1:5500/src/components/Hero/CostCalculator.html" class="inline-block bg-orange-500 text-white text-center py-2 px-4 rounded-lg hover:bg-orange-600">
